...
<head>
	...
	<title>Farm Equipment Hire and Rental Hub| Admin Dashboard</title>
...
?>
													...
													<div class="stat-panel-title text-uppercase">Reg Farmers</div>
												</div>
											</div>
...
?>
											...
											<a href="reg-owners.php" class="block-anchor panel-footer text-center">Full Detail <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
												<?php 
$sql1 ="SELECT id from tblequipment ";
...
?>
													...
													<div class="stat-panel-title text-uppercase">Added Equipments</div>
												</div>
											</div>
											<a href="manage-eq.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
...
$categorys=$query3->rowCount();
?>												
													<div class="stat-panel-number h1 "><?php echo htmlentities($categorys);?></div>
													<div class="stat-panel-title text-uppercase">Listed Equipment Category</div>
												</div>
											</div>
...
?>
													...
													<div class="stat-panel-title text-uppercase">Farmers Queries</div>
												</div>
											</div>
...
?>
													...
													<div class="stat-panel-title text-uppercase">Farmers Feedback</div>
												</div>
											</div>
