									...
									<div class="panel panel-default">
										...
										<form method="post" class="form-horizontal" enctype="multipart/form-data">
											<div class="form-group">
												...
												<div class="col-sm-3">
													<textarea class="form-control" name="ownerimp" rows="1" required><?php echo isset($user['Name']) ? $user['Name'] : '';?></textarea>
												</div>
												...
												<div class="form-group">
													...
													<label class="col-sm-3 control-label">Owner Phone<span style="color:red">*</span></label>
													<div class="col-sm-3">
														<textarea class="form-control" name="ownerimp" rows="1" required><?php echo isset($user['mob']) ? $user['mob'] : ''; ?></textarea>
													</div>
												</div>
													
												<div class="form-group">
														<label class="col-sm-2 control-label">Equipment Manufacturing Year <span style="color:red">*</span></label>
														<div class="col-sm-3">
															<input type="text" name="modelyear" class="form-control" required>
														</div>

														<label class="col-sm-3 control-label">Owner Address<span style="color:red">*</span></label>
														<div class="col-sm-3">
														<textarea class="form-control" name="ownerimp" rows="1" required><?php echo isset($user['address']) ? $user['address'] : ''; ?></textarea>
														</div>
												</div>
												...
												<div class="form-group">
														...
														<label class="col-sm-3 control-label">Select Village<span style="color:red">*</span></label>
														<div class="col-sm-3">
												...
												<div class="form-group">
														<label class="col-sm-2 control-label">Lifting Capacity (in Kg)<span style="color:red">*</span></label>
														<div class="col-sm-3">
												...
												<div class="form-group">
														<label class="col-sm-2 control-label">CC Capacity <span style="color:red">*</span></label>
														<div class="col-sm-3">
														<input type="textarea" id="inlineTextarea1" name="CC" class="form-control" required>
														</div>
												...
												<div class="form-group">
														...
														<label class="col-sm-3 control-label">Working Condition<span style="color:red">*</span></label>
														<div class="col-sm-3">
