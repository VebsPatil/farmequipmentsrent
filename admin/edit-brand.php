...
<head>
	...
	<title>Farm Equipment Hire and Rental Hub | Admin Update Category</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Update Equipment Category</h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Update Equipment Category</div>
...
?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Enter New Category Name</label>
												<div class="col-sm-8">
