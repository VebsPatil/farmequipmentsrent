...
$sql ="SELECT Name,Password FROM tlbadmin WHERE Name=:email and Password=:password";
...
<head>
	...
	<title>Farm Equipment Rental Portal | Admin Login</title>
						...
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
								<form method="post">
									...
									<input type="text" placeholder="Name" name="username" class="form-control mb">
